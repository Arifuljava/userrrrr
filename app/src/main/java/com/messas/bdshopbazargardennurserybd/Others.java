...
public class Others extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        topAnimation = AnimationUtils.loadAnimation(Others.this, R.anim.splash_top_animation);
        bottomAnimation = AnimationUtils.loadAnimation(Others.this, R.anim.splash_bottom_animation);
        startAnimation = AnimationUtils.loadAnimation(Others.this, R.anim.splash_start_animation);
        endAnimation = AnimationUtils.loadAnimation(Others.this, R.anim.splash_end_animation);
        ...
        Query query = firebaseFirestore.collection("Products").document("101").collection("Others");
            ...
            protected void onBindViewHolder(@NonNull MovieViewHolder viewHolder, final int position, @NonNull GenericProductModel model) {
                ...
                viewHolder.mView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Intent intent = new Intent(Others.this, IndividualProductActivity3.class);
    ...
    public void viewCart(View view) {
        startActivity(new Intent(Others.this, CartActivity.class));
        finish();
    }
