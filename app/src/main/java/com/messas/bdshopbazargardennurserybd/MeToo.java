...
public class MeToo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        topAnimation = AnimationUtils.loadAnimation(MeToo.this, R.anim.splash_top_animation);
        bottomAnimation = AnimationUtils.loadAnimation(MeToo.this, R.anim.splash_bottom_animation);
        startAnimation = AnimationUtils.loadAnimation(MeToo.this, R.anim.splash_start_animation);
        endAnimation = AnimationUtils.loadAnimation(MeToo.this, R.anim.splash_end_animation);
        ...
        Query query = firebaseFirestore.collection("Products").document("101").collection(cus_name);
            ...
            protected void onBindViewHolder(@NonNull Bags111.MovieViewHolder viewHolder, final int position, @NonNull GenericProductModel model) {
                ...
                viewHolder.mView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Intent intent = new Intent(MeToo.this, IndividualProductActivity5.class);
    ...
    public void viewCart(View view) {
        startActivity(new Intent(MeToo.this, CartActivity.class));
        finish();
    }
