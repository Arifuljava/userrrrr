...
public class Tshirts extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        topAnimation = AnimationUtils.loadAnimation(Tshirts.this, R.anim.splash_top_animation);
        bottomAnimation = AnimationUtils.loadAnimation(Tshirts.this, R.anim.splash_bottom_animation);
        startAnimation = AnimationUtils.loadAnimation(Tshirts.this, R.anim.splash_start_animation);
        endAnimation = AnimationUtils.loadAnimation(Tshirts.this, R.anim.splash_end_animation);
        ...
        Query query = firebaseFirestore.collection("Products").document("101").collection("Women");
            ...
            protected void onBindViewHolder(@NonNull MovieViewHolder viewHolder, final int position, @NonNull GenericProductModel model) {
                ...
                viewHolder.mView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Intent intent = new Intent(Tshirts.this, IndividualProductActivity1.class);
    ...
    public void viewCart(View view) {
        startActivity(new Intent(Tshirts.this, CartActivity.class));
        finish();
    }
