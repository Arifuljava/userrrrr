...
public class WishlistActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /////animation
        topAnimation = AnimationUtils.loadAnimation(WishlistActivity.this, R.anim.splash_top_animation);
        bottomAnimation = AnimationUtils.loadAnimation(WishlistActivity.this, R.anim.splash_bottom_animation);
        startAnimation = AnimationUtils.loadAnimation(WishlistActivity.this, R.anim.splash_start_animation);
        endAnimation = AnimationUtils.loadAnimation(WishlistActivity.this, R.anim.splash_end_animation);
    ...
    private void populateRecyclerView() {
        ...
        adapter =new FirestoreRecyclerAdapter<SingleProductModel, WishlistActivity.WishlistViewHolder>(response) {
            ...
            protected void onBindViewHolder(@NonNull WishlistActivity.WishlistViewHolder viewHolder, final int position, @NonNull SingleProductModel model) {
                ...
                viewHolder.linearlauy.setAnimation(topAnimation);
    ...
    public static class WishlistViewHolder extends RecyclerView.ViewHolder{
        ...
        public WishlistViewHolder(View v) {
            ...
            linearlauy=v.findViewById(R.id.linearlauy);
        }
    }
