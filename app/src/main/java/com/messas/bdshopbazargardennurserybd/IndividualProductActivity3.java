...
public class IndividualProductActivity3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_individual_product3);
        ...
        wishlist_red.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                final KProgressHUD progressDialog = KProgressHUD.create(IndividualProductActivity3.this)
                ...
                firestore.collection("Wishlist").document(usermobile).collection(username + " Wishlist")
                    ...
                    public void onSuccess(Void aVoid) {
                        ...
                        Others.wishlist.remove(Long.valueOf(model.getCardid()));

                        Toasty.success(IndividualProductActivity3.this, "Removed from Wishlist", 2000).show();
                    }
                });
            }
        });
    ...
    private void initialize() {
        ...
        Log.d("xlr8", String.valueOf(Others.wishlist));
        Log.d("xlr8_id", String.valueOf(model.getCardid()));

        if (Others.wishlist.contains(Long.valueOf(model.getCardid()))) {
            Log.d("xlr8", "True");
        ...
        productname.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                final FlatDialog flatDialog = new FlatDialog(IndividualProductActivity3.this);
                        ...
                        .withFirstButtonListner(new View.OnClickListener() {
                            ...
                            public void onClick(View view) {
                                if (TextUtils.isEmpty(flatDialog.getLargeTextField().toString())) {
                                    Toast.makeText(IndividualProductActivity3.this, "Enter review", Toast.LENGTH_SHORT).show();
                                }
                                else {
                                    flatDialog.dismiss();
                                    Toast.makeText(IndividualProductActivity3.this, "Done", Toast.LENGTH_SHORT).show();
                                }
                            }
                        })
                        .show();
    ...
    TextWatcher productcount = new TextWatcher() {
        ...
        public void afterTextChanged(Editable s) {
            ...
            if (Integer.parseInt(quantityProductPage.getText().toString()) >= 500) {
                Toasty.error(IndividualProductActivity3.this, "Product Count Must be less than 500", Toast.LENGTH_LONG).show();
            }
        }
    ...
    public void addToWishList(View view) {
        ...
        firestore.collection("Wishlist").document(usermobile).collection(username + " Wishlist")
            ...
            public void onSuccess(Void aVoid) {
                ...
                Others.wishlist.add(Long.valueOf(model.getCardid()));
                Log.d("xlr8_wlv", String.valueOf(session.getWishlistValue()));
                Toasty.success(IndividualProductActivity3.this, "Added to your Wishlist", 2000).show();
            ...
            @Override
            public void onFailure(@NonNull Exception e) {
                Toasty.error(IndividualProductActivity3.this, "Failed to add.", 2000).show();
            }
        });
    ...
    public void goToCart(View view) {
        ...
        if (customheader.getText().toString().length() == 0 || custommessage.getText().toString().length() == 0) {
            ...
            startActivity(new Intent(IndividualProductActivity3.this, CartActivity.class));
            finish();
        }
    ...
    private void addToCartProcess(final boolean addToCart) {
        ...
        firestore.collection("Cart").document(useremail).collection(username + " Cart")
            ...
            public void onSuccess(Void aVoid) {
                ...
                if (addToCart == true) {
                    Toasty.success(IndividualProductActivity3.this, "Added to Cart", 2000).show();
                }
