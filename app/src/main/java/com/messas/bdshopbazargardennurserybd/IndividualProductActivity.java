    ...
    private void initialize() {
        ...
        productname.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                final FlatDialog flatDialog = new FlatDialog(IndividualProductActivity.this);
                        ...
                        .withFirstButtonListner(new View.OnClickListener() {
                            ...
                            public void onClick(View view) {
                                if (TextUtils.isEmpty(flatDialog.getLargeTextField().toString())) {
                                    Toast.makeText(IndividualProductActivity.this, "Enter review", Toast.LENGTH_SHORT).show();
                                }
                                else {
                                    flatDialog.dismiss();
                                    Toast.makeText(IndividualProductActivity.this, "Done", Toast.LENGTH_SHORT).show();
                                }
                            }
                        })
                        .show();
