...
public class IndividualProductActivity10 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_individual_product10);
        ...
        // Toast.makeText(this, ""+cardiddd, Toast.LENGTH_SHORT).show();
        ...
        wishlist_red.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                final KProgressHUD progressDialog=  KProgressHUD.create(IndividualProductActivity10.this)
                ...
                firestore.collection("Wishlist").document(usermobile).collection(username+" Wishlist")
                    ...
                    public void onSuccess(Void aVoid) {
                       ...
                       // AllcategoruySearch.wishlist.remove(Long.valueOf(model.getCardid()));

                        Toasty.success(IndividualProductActivity10.this,"Removed from Wishlist",2000).show();
                    }
                });
            }
        });
    ...
    private void initialize() {
        ...
        productname.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                final FlatDialog flatDialog = new FlatDialog(IndividualProductActivity10.this);
                        ...
                        .withFirstButtonListner(new View.OnClickListener() {
                            ...
                            public void onClick(View view) {
                                if (TextUtils.isEmpty(flatDialog.getLargeTextField().toString())) {
                                    Toast.makeText(IndividualProductActivity10.this, "Enter review", Toast.LENGTH_SHORT).show();
                                }
                                else {
                                    flatDialog.dismiss();
                                    Toast.makeText(IndividualProductActivity10.this, "Done", Toast.LENGTH_SHORT).show();
                                }
                            }
                        })
                        .show();
    ...
    TextWatcher productcount = new TextWatcher() {
        ...
        public void afterTextChanged(Editable s) {
            ...
            if (Integer.parseInt(quantityProductPage.getText().toString()) >= 500) {
                Toasty.error(IndividualProductActivity10.this, "Product Count Must be less than 500", Toast.LENGTH_LONG).show();
            }
        }
        ...
        firestore.collection("Wishlist").document(usermobile).collection(username+" Wishlist")
            ...
            public void onSuccess(Void aVoid) {
               ...
               // ShoesActivity.wishlist.add(Long.valueOf(model.getCardid()));
                Log.d("xlr8_wlv", String.valueOf(session.getWishlistValue()));
                Toasty.success(IndividualProductActivity10.this,"Added to your Wishlist",2000).show();
            ...
            @Override
            public void onFailure(@NonNull Exception e) {
                Toasty.error(IndividualProductActivity10.this,"Failed to add.",2000).show();
            }
        });
    ...
    public void goToCart(View view) {
        ...
        if ( customheader.getText().toString().length() == 0 ||  custommessage.getText().toString().length() ==0 ){
            ...
            startActivity(new Intent(IndividualProductActivity10.this, CartActivity.class));
            finish();
        }
    ...
    private void addToCartProcess(final boolean addToCart){
        ...
        firestore.collection("Cart").document(useremail).collection(username+" Cart")
            ...
            public void onSuccess(Void aVoid) {
                ...
                if (addToCart==true) {
                    Toasty.success(IndividualProductActivity10.this, "Added to Cart", 2000).show();
                }
