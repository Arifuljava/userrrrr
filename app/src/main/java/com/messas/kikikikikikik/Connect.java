...
public class Connect extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        topAnimation = AnimationUtils.loadAnimation(Connect.this, R.anim.splash_top_animation);
        bottomAnimation = AnimationUtils.loadAnimation(Connect.this, R.anim.splash_bottom_animation);
        startAnimation = AnimationUtils.loadAnimation(Connect.this, R.anim.splash_start_animation);
        endAnimation = AnimationUtils.loadAnimation(Connect.this, R.anim.splash_end_animation);
        ...
        Query query = firebaseFirestore.collection("Products").document("101").collection("Kids99");
        ...
        adapter =new FirestoreRecyclerAdapter<GenericProductModel, Bags111.MovieViewHolder>(response) {
            @Override
            protected void onBindViewHolder(@NonNull Bags111.MovieViewHolder viewHolder, final int position, @NonNull GenericProductModel model) {
                ...
                viewHolder.mView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Intent intent = new Intent(Connect.this, IndividualProductActivity4.class);
            ...
            @NonNull
            @Override
            public Bags111.MovieViewHolder onCreateViewHolder(@NonNull ViewGroup group, int viewType) {
                Log.d(TAG,"Inflating Layout");
                View view = LayoutInflater.from(group.getContext())
                        .inflate(R.layout.cards_cardview_layout, group, false);

                return new Bags111.MovieViewHolder(view);
            }
    ...
    public void viewCart(View view) {
        startActivity(new Intent(Connect.this, CartActivity.class));
        finish();
    }
